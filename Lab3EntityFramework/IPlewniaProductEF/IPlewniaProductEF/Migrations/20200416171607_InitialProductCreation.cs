...
namespace IPlewniaProductEF.Migrations
{
    public partial class InitialProductCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MediatorProduct",
                columns: table => new
                {
                    MediatorProductID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProductID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediatorProduct", x => x.MediatorProductID);
                    table.ForeignKey(
                        name: "FK_MediatorProduct_Invoices_InvoiceID",
                        column: x => x.InvoiceID,
                        principalTable: "Invoices",
                        principalColumn: "InvoiceID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MediatorProduct_Products_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediatorProduct_InvoiceID",
                table: "MediatorProduct",
                column: "InvoiceID");

            migrationBuilder.CreateIndex(
                name: "IX_MediatorProduct_ProductID",
                table: "MediatorProduct",
                column: "ProductID");
